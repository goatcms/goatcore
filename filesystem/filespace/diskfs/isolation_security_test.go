...
func TestCopyIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestCopyIsolation"); err != nil {
		t.Error(err)
		return
	}
...
func TestCopyDirectoryIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestCopyDirectoryIsolation"); err != nil {
		t.Error(err)
		return
	}
	if err = fs.MkdirAll("src/d1/d2/d3", filesystem.DefaultUnixDirMode); err != nil {
...
func TestCopyFileIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestCopyFileIsolation"); err != nil {
		t.Error(err)
		return
	}
...
func TestReadDirIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestReadDirIsolation"); err != nil {
		t.Error(err)
		return
	}
...
func TestIsExistIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestIsExistIsolation"); err != nil {
		t.Error(err)
		return
	}
...
func TestIsFileIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestIsFileIsolation"); err != nil {
		t.Error(err)
		return
	}
	if err = fs.WriteFile("src.txt", []byte{1, 2, 3}, filesystem.DefaultUnixFileMode); err != nil {
...
func TestIsDirIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestIsDirIsolation"); err != nil {
		t.Error(err)
		return
	}
...
func TestMkdirAllIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestMkdirAllIsolation"); err != nil {
		t.Error(err)
		return
	}
	if err = fs.MkdirAll("child", filesystem.DefaultUnixDirMode); err != nil {
...
func TestWriterIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestWriterIsolation"); err != nil {
		t.Error(err)
		return
	}
...
func TestReaderIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestReaderIsolation"); err != nil {
		t.Error(err)
		return
	}
	if err = fs.WriteFile("src.txt", []byte{1, 2, 3}, filesystem.DefaultUnixFileMode); err != nil {
...
func TestReadFileIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestReadFileIsolation"); err != nil {
		t.Error(err)
		return
	}
	if err = fs.WriteFile("src.txt", []byte{1, 2, 3}, filesystem.DefaultUnixFileMode); err != nil {
...
func TestWriteFileIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestWriteFileIsolation"); err != nil {
		t.Error(err)
		return
	}
	if err = fs.MkdirAll("child", filesystem.DefaultUnixDirMode); err != nil {
...
func TestRemoveIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestRemoveIsolation"); err != nil {
		t.Error(err)
		return
	}
...
func TestRemoveAllIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestRemoveAllIsolation"); err != nil {
		t.Error(err)
		return
	}
...
func TestFilespaceIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestFilespaceIsolation"); err != nil {
		t.Error(err)
		return
	}
...
func TestLstatIsolation(t *testing.T) {
	...
	if fs, err = NewBaseFS(t, "TestLstatIsolation"); err != nil {
		t.Error(err)
		return
	}
